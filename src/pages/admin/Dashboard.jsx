          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{userStats.totalRegistered}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">New Today:</span>
                <span className="font-medium text-green-500">+{userStats.newToday}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Active Last Week:</span>
                <span className="font-medium text-blue-500">{userStats.activeLastWeek}</span>
              </div>
            </div>
          </div>

          {/* Updated Online Bakers Card */}
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Verified Bakers:</span>
                <span className="font-medium">{bakerStats.totalVerified}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Pending Verification:</span>
                <span className="font-medium text-orange-500">{bakerStats.pendingVerification}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Top Performer:</span>
                <span className="font-medium text-green-500">{bakerStats.topPerformer}</span>
              </div>
            </div>
          </div>

          {/* Updated Online Customers Card */}
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              <div className="rounded-full p-3 bg-green-100">
                <Icon 
            ...
            <div className="mt-4 space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{customerStats.totalActive}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Orders Today:</span>
                <span className="font-medium text-blue-500">{customerStats.ordersToday}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-500">Avg. Order Value:</span>
                <span className="font-medium text-green-500">
                  ₱ {customerStats.averageOrderValue.toLocaleString('en-PH', { minimumFractionDigits: 2 })}
                </span>
              </div>
            </div>
          </div>
