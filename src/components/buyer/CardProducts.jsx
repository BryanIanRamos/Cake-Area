          ...
          <form>
            <div className="relative flex items-center max-w-[8rem]">
              <button
                type="button"
                id="decrement-button"
                className="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-s-lg p-1.5 md:p-3 h-6 md:h-8 focus:ring-gray-100 focus:ring-2 focus:outline-none"
              >
                <svg
                  className="w-1 h-1 md:w-2 md:h-2 text-gray-900"
                  aria-hidden="true"
              ...
              <input
                ...
                id="quantity-input"
                data-input-counter
                className="bg-gray-50 border-x-0 border-gray-300 h-6 md:h-8 text-center text-gray-900 text-xs md:text-sm focus:ring-blue-500 focus:border-blue-500 block w-full py-1.5 md:py-2.5"
                placeholder="999"
                value="5"
                required
              />
              <button
                type="button"
                id="increment-button"
                className="bg-gray-100 hover:bg-gray-200 border border-gray-300 rounded-e-lg p-1.5 md:p-3 h-6 md:h-8 focus:ring-gray-100 focus:ring-2 focus:outline-none"
              >
                <svg
                  className="w-1 h-1 md:w-2 md:h-2 text-gray-900"
                  aria-hidden="true"
