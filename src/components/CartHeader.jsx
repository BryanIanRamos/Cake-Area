...
const CartHeader = () => {
  ...
  return (
    <div className="bg-secondary text-white py-4 px-4 md:px-8 lg:px-40 fixed top-0 left-0 right-0 z-50"> 
      <div className="flex justify-between items-center">
        {/* Logo - hidden when search is open on mobile */}
        <div className={`flex gap-2 items-center text-2xl md:text-3xl font-bold ${isSearchOpen ? 'hidden md:flex' : 'flex'}`}>
          <img className='w-12 h-12 md:w-16 md:h-16' src='src\assets\white-logo.png' alt="logo"/>
          Cake Area
        </div>
        ...
        <div className="relative flex items-center ml-auto">
          ...
          <div className={`${isSearchOpen ? 'flex w-full' : 'hidden md:flex'} relative w-full md:w-auto`}>
            <input
              type="text"
