...
const ProductModal = ({ isOpen, onClose, order }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg max-w-4xl w-full shadow-xl max-h-[90vh] overflow-y-auto relative">
        {/* Sticky Header Group */}
            ...
            <div className="bg-orange-50 rounded-xl p-6 border border-orange-100 shadow-sm">
              <div className="grid grid-cols-3 gap-6">
                <div>
                  ...
                  <p className="font-bold text-[#E88F2A] text-lg">
                    #{order.order_id}
                  </p>
                </div>
                <div>
              ...
              <div className="space-y-3">
                <p className="text-sm">
                  ...
                  <span className="text-gray-800 font-semibold">
                    {order.placedAddress?.fullName}
                  </span>
                </p>
                <p className="text-sm">
                  <span className="text-gray-500 font-medium">Phone:</span>{" "}
                  <span className="text-gray-800 font-semibold">
                    {order.placedAddress?.phoneNumber}
                  </span>
                </p>
                <p className="text-sm">
                  <span className="text-gray-500 font-medium">Address:</span>{" "}
                  <span className="text-gray-800 font-semibold">
                    {order.placedAddress?.streetAddress},{" "}
                    {order.placedAddress?.cityBarangay},{" "}
                    {order.placedAddress?.postalCode}
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <p className="text-sm">
                  ...
                  <span className="font-semibold text-[#E88F2A]">
              ...
              {order.products.map((product, index) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="font-bold text-lg text-[#E88F2A]">
            ...
            <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
              <div className="space-y-4">
                ...
                <div className="border-t border-gray-200 pt-4 mt-4 flex justify-between items-center">
                  ...
                  <span className="font-bold text-xl text-[#E88F2A]">
